 ...
 *      - Popup boxes and menu icons.
 *      - Backwards compatibility with other plugins.
 * - 7/2/21
 *      - Documented relevant parts.
 *      - Removed pointless legacy code.
 *      - Traced visibile/invisible fucntionality to single function being inherited from source code.
 * - 7/6/21
 *      - Began attempting to swap visibility toggle with highlighting toggle.
 *      - Mapped out available built-in functions.
 * - 7/7/21
 *      - Figured out how to manipulate stroke color and width.
 *      - Illums can turn on the highlights for their respective cells.
 *      - Illums can only fire one at a time now.
 *      - When illums are deselected, cells go back to default stroke settings.
 *      - Enabled cells to be in multiple illums.
 * - 7/8/21
 *      - Stroke colors and width are detected and stored to return to after illum is off.
 *      - Fixed bug forcing all colors to be unchangeable after illum use.
 *      - Set constants for the hgihlights and fixed random red arrow bug.
 *      - Cleaned code and started to document.
 * - 7/9/21
 *      - Further cleaned and commented code.
 *      - Wrote documentation on how to use this plugin.
 * 
 * TODO:
